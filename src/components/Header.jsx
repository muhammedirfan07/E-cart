    ...
    {/* seach product Name */}
     {
      ...
      <input  onChange={(e)=>dispatch(searchProduct(e.target.value.toLowerCase()))} style={{width:'300px'}} className='rounded p-2 text-black' type="text" placeholder='search product' />
    </li>
     }
      ...
      <Link to={'/cart'}>
        <i className='fa-solid fa-cart-plus text-amber-700'></i>
          <span>Cart</span>
          <span className='bg-black text-white rounded-2xl p-1'>{userCart?.length}</span>
      </Link>
      </li>
